...
import "./lib/berkeley-mono.css";
import "./lib/ioskeley-mono.css";
...
// Berkeley 是界面和终端的默认正文，~32KB，首屏就拉。
// 不带文本的 Maple load 只命中拉丁片（~40KB）；5MB 的 CJK 片留到空闲时预取——
// 首屏不占带宽，等终端真输出中文时它多半已经就位，即使没就位，
// TerminalView 监听的 fonts loadingdone 也会在片子到达后重建 atlas。
void document.fonts.load(`13px "${BERKELEY_FONT_FAMILY}"`);
